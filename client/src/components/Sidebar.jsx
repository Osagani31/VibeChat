    ...
    <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? "max-md:hidden":''}`}>
        ...
        <div className='pb-5'>
         ...
         <div className="relative py-2 group">
            <button type="button" className='block rounded-md focus:outline-none focus:ring-2 focus:ring-white/30'>
              <img src={assets.menu_icon} alt="Menu" className='max-h-5 cursor-pointer'/>
            </button>
            <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md
            bg-[#282142] border border-gray-600 text-gray-100 hidden group-hover:block group-focus-within:block'>
        ...
        <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5' >
           ...
           text-white text-xs placeholder-[#c8c8c8] flex-1' placeholder='Search Users...' />
        </div>
