    ...
    justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
...

      {
        currState === "Sign up" && isDataSubmitted && (
          ...
          focus:outline-none focus:ring-indigo-500' placeholder='Provide a short bio....'></textarea>
        )
      }

      <button type='submit' className='py-3 bg-gradient-to-r from-purple-400 to-violet-600
      text-white rounded-md cursor-pointer'>
        {currState==="Sign up" ? (isDataSubmitted ? "Complete Signup" : "Create Account") : "Login Now"}
      </button>
     ...
     {currState === "Sign up" ? (
      ...
      <span onClick={()=>{setCurrState("Sign up"); setIsDataSubmitted(false)}}
